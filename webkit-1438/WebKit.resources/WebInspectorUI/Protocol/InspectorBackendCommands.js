...
InspectorBackend.registerEvent("CSS.nodeLayoutContextTypeChanged", null, ["nodeId", "layoutContextType"]);
...
InspectorBackend.registerCommand("DOM.resolveNode", ["page"], [{"name": "nodeId", "type": "number", "optional": true}, {"name": "objectId", "type": "string", "optional": true}, {"name": "executionContextId", "type": "number", "optional": true}, {"name": "objectGroup", "type": "string", "optional": true}], ["object"]);
...
InspectorBackend.registerEvent("Page.willRequestOpenWindow", null, ["url"]);
InspectorBackend.registerEvent("Page.didRequestOpenWindow", null, ["opened"]);
...
InspectorBackend.registerCommand("Screencast.start", null, [{"name": "file", "type": "string"}, {"name": "width", "type": "number"}, {"name": "height", "type": "number"}, {"name": "scale", "type": "number", "optional": true}], ["screencastId"]);
InspectorBackend.registerCommand("Screencast.stop", null, [], []);
